...
class ControllersControllerTest < ActionController::TestCase
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post :create, controller: { Author: @controller.Author, email: @controller.email, password: @controller.password, password_confirmation: @controller.password_confirmation, username: @controller.username }
    end
  ...
  test "should update controller" do
    put :update, id: @controller, controller: { Author: @controller.Author, email: @controller.email, password: @controller.password, password_confirmation: @controller.password_confirmation, username: @controller.username }
    assert_redirected_to controller_path(assigns(:controller))
  end
